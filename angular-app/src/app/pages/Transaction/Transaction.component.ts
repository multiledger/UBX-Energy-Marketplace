...
export class TransactionComponent implements OnInit {
  ...
  myForm: FormGroup;
  public errorMessage;
  public transactionFrom; //change when transaction is done

  public prosumerName = "Prosumer Not Found";
  public consumerName = "Consumer Not Found";
  ...
  getProsumerAndConsumer() {
    this.dataService.getAccount(this.producerID)
      .subscribe((data: Account) => {
        this.prosumerName = data.name
      });


    this.dataService.getAccount(this.consumerID)
      .subscribe((data: Account) => {
        this.consumerName = data.name
      });
  }
