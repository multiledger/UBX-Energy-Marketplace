...
export class DashboardComponent implements OnInit {
  ...
  public prosumerCoin: number;
  public prosumerEnergyProduced: number;
  public prosumerEnergySold: number;
  public prosumerEnergyStored: number;
  private prosumerBarChart: any[];
  private prosumerLineChart: any[];

  // define variables for consumer
  public consumerCoin: number;
